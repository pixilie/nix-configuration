      ...
      programs.waybar = {
        ...
        style = ''
          ...
          * { font-family: "CaskaydiaCove Nerd Font", "Font Awesome 6 Free", sans-serif; font-size: 13px; border-radius: 0; }
          ...
          #battery.critical:not(.charging) { background-color: @base08; animation: blink 0.5s linear infinite alternate; }
          ...
          #gamemode { color: @base00; background-color: @base08; padding: 0 .7rem; }
          .modules-right widget .module { padding: 0 .7rem; color: @base07; }
